...
class ContactInfo extends React.Component {
  render() {
    return (<Paper style={{ padding: 16, marginTop: 16 }}>
                ...
                <a href="mailto:hkkilian@gmail.com" style={{ color: 'inherit', textDecoration: 'inherit', cursor: 'pointer' }}><FontAwesome name='envelope' style={iconStyle} />hkkilian@gmail.com</a>
                <div style={{ width: 30, display: 'inline-block' }} ></div>
